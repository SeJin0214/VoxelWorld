...
SkyBox::SkyBox(GPUResourceService& gpuResourceService)
	...
	, mShaderResourceView(gpuResourceService.CreateTextureAndSRVForSkyBox(L"assets/SkyBox2.dds"))
	, mVertexShader(gpuResourceService.CreateVertexShader(gpuResourceService.CompileVertexShader(GetShaderFileName()).Get()))
	, mPixelShader(gpuResourceService.CreatePixelShader(gpuResourceService.CompilePixelShader(GetShaderFileName()).Get()))
	, mInputLayout(gpuResourceService.CreateInputLayoutForSkyBox(gpuResourceService.CompileVertexShader(GetShaderFileName()).Get()))
{
