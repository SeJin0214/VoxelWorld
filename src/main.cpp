...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	deviceBundle.Device->QueryInterface(__uuidof(ID3D11Debug), (void**)&d3dDebug);

	deviceBundle.DeviceContext->Flush();
	deviceBundle.DeviceContext->ClearState();

	deviceBundle.SwapChain.Reset();
	deviceBundle.DeviceContext.Reset();
	deviceBundle.Device.Reset();
